...
public class RecursosService {
  ...
  private Border bInferiorAzul, bInferiorGris, bGris;
  ...
  private void crearImagenes() {
    iCerrar = new ImageIcon("Clase10/resources/images/cerrar.png");
    iMinimizar = new ImageIcon("Clase10/resources/images/minimizar.png");
  }
  ...
  private void generarFuentes() {
    try {
      ...
      ge.registerFont( Font.createFont(
          Font.TRUETYPE_FONT,
          new File("Clase10/resources/fonts/LUZRO.ttf")
      ));
